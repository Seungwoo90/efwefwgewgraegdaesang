...
if __name__ == "__main__":
    ...
    dir4 = directories[1201:]
    ##########################################################
    
    for directory in dir3:
    ...
    with open('OCR_OUTPUT_3.txt', mode='a') as file:
    ...
    with open('OCR_OUTPUT_3.json', 'w') as file:
    ...
    df = df[cols]
    df.to_csv('OCR_OUTPUT_3.csv', index=False)
